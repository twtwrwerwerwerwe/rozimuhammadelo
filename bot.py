...
user_data = {}
last_messages = {}  # oxirgi yuborilgan xabarlarni saqlash
            ...
            while not user_data.get(user_id, {}).get("stop"):
                ...
                for group in GROUPS:
                    ...
                    try:
                        ...
                        await asyncio.sleep(e.seconds)  # 🔥 floodni kutib turadi, keyin davom etadi
                ...
                await asyncio.sleep(180)  # 3 minutdan keyin yana boshlaydi
